/**
 * @license Apache-2.0
 * Sidebar entry for TitanX Observability hub.
 */
...
const SiderObservabilityEntry: React.FC<Props> = ({ isMobile, isActive, collapsed, siderTooltipProps, onClick }) => {
  const { t } = useTranslation();

  if (collapsed) {
    return (
      <Tooltip {...siderTooltipProps} content={t('observability.title', 'Observability')} position='right'>
        <div
...
export default SiderObservabilityEntry;
