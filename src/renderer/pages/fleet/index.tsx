...
const FleetPage: React.FC = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center h-full min-h-400px w-full p-6 text-center'>
      ...
      <h1 className='text-xl font-semibold text-t-primary mb-2'>{t('master.placeholder.title')}</h1>
      <p className='text-sm text-t-secondary max-w-500px leading-relaxed'>{t('master.placeholder.body')}</p>
    </div>
  );
};
